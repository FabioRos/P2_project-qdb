...
# Generated by qmake (2.01a) (Qt 4.8.6) on: sab set 6 20:24:07 2014
...
SOURCES       = bicicletta.cpp \
		...
		negozio.cpp \
		record.cpp \
		tabella.cpp moc_finestra_principale.cpp \
		moc_inserimento.cpp \
		moc_record.cpp \
		moc_tabella.cpp
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/prjP2New1.0.0/ && $(COPY_FILE) --parents bicicletta.h bicicomuni.h bicidacorsa.h container.h eccezioni.h file_manager.h finestra_principale.h inserimento.h negozio.h record.h tabella.h utilita.h .tmp/prjP2New1.0.0/ && $(COPY_FILE) --parents bicicletta.cpp bicicomuni.cpp bicidacorsa.cpp eccezioni.cpp finestra_principale.cpp inserimento.cpp main.cpp negozio.cpp record.cpp tabella.cpp .tmp/prjP2New1.0.0/ && (cd `dirname .tmp/prjP2New1.0.0` && $(TAR) prjP2New1.0.0.tar prjP2New1.0.0 && $(COMPRESS) prjP2New1.0.0.tar) && $(MOVE) `dirname .tmp/prjP2New1.0.0`/prjP2New1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/prjP2New1.0.0
...
compiler_moc_header_make_all: moc_finestra_principale.cpp moc_inserimento.cpp moc_record.cpp moc_tabella.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_finestra_principale.cpp moc_inserimento.cpp moc_record.cpp moc_tabella.cpp
...
moc_inserimento.cpp: negozio.h \
		...
		container.h \
		inserimento.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) inserimento.h -o moc_inserimento.cpp

moc_record.cpp: bicicletta.h \
		eccezioni.h \
		utilita.h \
		bicicomuni.h \
		bicidacorsa.h \
		...
		negozio.h \
		record.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) record.h -o moc_record.cpp

moc_tabella.cpp: negozio.h \
		bicicletta.h \
		eccezioni.h \
		utilita.h \
		bicidacorsa.h \
		...
		record.h \
		tabella.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) tabella.h -o moc_tabella.cpp
...
inserimento.o: inserimento.cpp inserimento.h \
		negozio.h \
		bicicletta.h \
		eccezioni.h \
		utilita.h \
		...
		bicicomuni.h \
		container.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o inserimento.o inserimento.cpp

main.o: main.cpp negozio.h \
		bicicletta.h \
		eccezioni.h \
		utilita.h \
		bicidacorsa.h \
...
tabella.o: tabella.cpp tabella.h \
		...
		container.h \
		record.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o tabella.o tabella.cpp
...
moc_inserimento.o: moc_inserimento.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_inserimento.o moc_inserimento.cpp

moc_record.o: moc_record.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_record.o moc_record.cpp

moc_tabella.o: moc_tabella.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_tabella.o moc_tabella.cpp
