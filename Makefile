...
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile prjP2New.pro
#############################################################################
...
Makefile: prjP2New.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d .tmp/prjP2New1.0.0 || mkdir -p .tmp/prjP2New1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/prjP2New1.0.0/ && $(COPY_FILE) --parents bicicletta.h bicicomuni.h bicidacorsa.h container.h eccezioni.h .tmp/prjP2New1.0.0/ && $(COPY_FILE) --parents bicicletta.cpp bicicomuni.cpp bicidacorsa.cpp eccezioni.cpp main.cpp .tmp/prjP2New1.0.0/ && (cd `dirname .tmp/prjP2New1.0.0` && $(TAR) prjP2New1.0.0.tar prjP2New1.0.0 && $(COMPRESS) prjP2New1.0.0.tar) && $(MOVE) `dirname .tmp/prjP2New1.0.0`/prjP2New1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/prjP2New1.0.0
